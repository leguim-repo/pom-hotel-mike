...
public class pruebaRoomsAvailable {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Query avaiRooms = session.createQuery(new StringBuilder().append("FROM RoomsEntity r LEFT JOIN BookingsEntity b ON r.id = b.roomsByFkRoomId WHERE r.guests >= 1 AND r.pricePerNight >= 20 AND r.pricePerNight <= 1000 AND r.roomtypesByFkRoomtypeId = '1' AND NOT EXISTS").append("(FROM BookingsEntity b WHERE b.roomsByFkRoomId == r.id AND ('2020-10-09' BETWEEN b.checkIn AND b.checkOut OR '2020-10-15' BETWEEN b.checkIn AND b.checkOut OR ('2020-10-09' <= \n").append("b.checkIn AND '2020-10-15' >= b.checkOut)))").toString());
